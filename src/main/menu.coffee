...
module.exports = class
  ...
  constructor: ->
    ...
    #     label: 'Quit'
    #     accelerator: 'Command+Q'
    #     click: -> mediator.emit 'quit-requested'
    #   ,
    #     label: 'Hide Electron'
    #     accelerator: 'Command+H'
    #     selector: 'hide:'
    ...
    #     label: 'Open'
    #     accelerator: 'Command+O'
    #     click: -> mediator.emit 'open-file-requested'
    #   ]
    # ,
    #   label: 'Display'
    #   submenu: [
    ...
    #     click: -> mediator.emit 'open-dev-tools-requested'
    #   ]
    # ,
    #   label: 'Window'
    #   submenu: [
    ...
    #     accelerator: 'Command+N'
    #     click: -> mediator.emit 'open-new-window-requested'
    #   ]
    # ,
    #   label: 'Help'
    #   submenu: []
